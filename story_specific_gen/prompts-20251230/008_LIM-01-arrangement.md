...
- important details: Clean service concourse; barcode kiosk labeled for incident processing; directional railings and incident queue stanchions; sealed bay door leading toward the mirror-surface aperture; clear exit/signage toward Intake Hall

## HOTSPOTS
- Barcode kiosk - central
- Incident queue stanchions - center
- Sealed bay door - left (aperture side)
