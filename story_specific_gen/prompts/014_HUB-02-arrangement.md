...
- important details: Small guard shack with porch overhang; door with card reader (indicator barely lit); call box on post with tangled conduit; dead pneumatic-tube label plate mounted near the door

## HOTSPOTS
- Guard shack door
- Card reader - beside door handle
- Call box speaker and button - on post
- Pneumatic tube label plate - near the door
