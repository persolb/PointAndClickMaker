...
- important details: Service corridor with cable trays and duct runs; ventilation access panel for damper task; door to admin wing service entry; door to operations wing (scope-labeled)

## HOTSPOTS
- Ventilation access panel
- Operations wing service door
- Cable tray label cluster

## SCREENS TRANSITION POINTS
- Exterior Ground Service Hatch
  - Direction: down
  - Transition: return_to_meter_room
- Admin Lobby and Kiosk
  - Direction: right
  - Transition: enter_admin_service_entry
- Operations Corridor (Interlocks and LOTO)
  - Direction: onscreen
  - Transition: enter_ops_service_entry
