...
- important details: Workbench with tool fixtures and seal punch; scope tags and warranty postings; registry reader that accepts AMR tag; parts bins labeled by service class (not function)
