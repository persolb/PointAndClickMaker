...
- important details: Copier with service-code prompt; fax machine with low toner warning; supply shelves with paper/toner/tabs/binders; sticker-over-sticker layer on service code label

## HOTSPOTS
- Copier control panel - centered
- Service code sticker stack
- Fax machine tray
- Binder supplies shelf

## SCREENS TRANSITION POINTS
- Records Hallway and Tube Station
  - Direction: left
  - Transition: door to records_hall
- Non-Local Compliance Notices Room
  - Direction: right
  - Transition: hallway to corridor_to_notices
